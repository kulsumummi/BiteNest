"""
Django settings for BiteNest project.
"""
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'bitenest-secure-secret-key-change-in-production')
...
# Conditionally enable WhiteNoise middleware if installed
try:
    import whitenoise
